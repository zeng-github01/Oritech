...
import rearth.oritech.client.renderers.PowerPoleLineRenderer;
...
@Mixin({AcceleratorControllerRenderer.class, LaserArmRenderer.class, MachineGantryRenderer.class, PowerPoleLineRenderer.class})
