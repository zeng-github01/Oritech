...
<center>
<ModAsset location="oritech:cybernetics" width={400} />
</center>
...
2. Each augmentation has unique energy and resource costs (stored in the center's inventory)
...
<Callout variant="info">
    All research/applications costs and durations are configurable via datapacks
</Callout>
