...
Each burst addon increases the maximum burst time by 4 seconds. Multiple burst addons can be used to increase the maximum burst time. However, for machines that should run
